...
from property.views.comments_views import PropertyCommentView, CreateReservationCommentView, UpdateUserToPropertyRatingView, UpdateHostToUserRatingView, UpdateHostToUserMsgView, UserCommentView
